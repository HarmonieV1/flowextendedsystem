...
const connectors = [
  ...
  coinbaseWallet({ appName: 'FXSEDGE', appLogoUrl: 'https://fxsedge.com/favicon.svg' }),
]

// WalletConnect peut crash sur certains browsers — on l'ajoute en try/catch
try {
  connectors.push(walletConnect({ projectId: WC_PROJECT_ID, metadata: {
    name: 'FXSEDGE',
    description: 'Terminal de trading no-KYC',
    url: 'https://fxsedge.com',
    icons: ['https://fxsedge.com/favicon.svg'],
  }}))
} catch(e) { console.warn('[WAGMI] WalletConnect init failed:', e.message) }
